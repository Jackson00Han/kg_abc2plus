...
| 8. Automated evaluation and regression gates | Complete | `docs/automated_evaluation.md`; `docs/validation/stage-8.md`; current baseline 1.2.0 covers 499 unit + 9 HTTP E2E + 22 security + 2 regression + 101 disposable-Neo4j tests plus the locked industrial extraction-quality gate; published completion and later baseline maintenance are recorded separately |
