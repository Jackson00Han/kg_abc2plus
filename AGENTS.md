...
| 8. Automated evaluation and regression gates | Complete | `docs/automated_evaluation.md`; `docs/validation/stage-8.md`; current baseline 1.5.0 covers 707 unit + 15 HTTP E2E + 33 security + 2 regression + 133 disposable-Neo4j tests plus the locked industrial extraction-quality gate; published completion and later baseline maintenance are recorded separately; source-only initialization, browser checks, live-provider evidence and remaining limits are recorded in `docs/validation/industrial-demo-workbench.md` |
