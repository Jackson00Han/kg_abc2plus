...
| 8. Automated evaluation and regression gates | Complete | `docs/automated_evaluation.md`; `docs/validation/stage-8.md`; current baseline 1.6.0 covers 724 unit + 16 HTTP E2E + 33 security + 2 regression + 135 disposable-Neo4j tests plus the locked industrial extraction-quality gate; published completion and later baseline maintenance are recorded separately; complete capture, final scoped checks and guided construction limits are recorded in `docs/validation/guided-construction-review.md` |
