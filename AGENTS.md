...
| 8. Automated evaluation and regression gates | Complete | `docs/automated_evaluation.md`; `docs/validation/stage-8.md`; current baseline 1.1.0 covers 327 unit + 5 HTTP E2E + 15 security + 2 regression + 75 disposable-Neo4j tests; published completion and later baseline maintenance are recorded separately |
