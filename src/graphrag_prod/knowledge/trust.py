...
class KnowledgeOrigin(StrEnum):
    ...
    MAPPED = "MAPPED"
    AUTHORITATIVE_MAPPED = "AUTHORITATIVE_MAPPED"
...
_ALLOWED_AUTHORITY_BY_ORIGIN: dict[KnowledgeOrigin, AuthorityLevel] = {
    ...
    KnowledgeOrigin.MAPPED: AuthorityLevel.SECONDARY,
    KnowledgeOrigin.AUTHORITATIVE_MAPPED: AuthorityLevel.AUTHORITATIVE,
